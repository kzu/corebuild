...
if "%VisualStudioVersion%" == "" (
  for /f "delims=" %%i in ('msbuild -nologo -noautoresponse %Root%corebuild\corebuild.targets /t:_GetVsInstallRoot /v:minimal') do set "VsInstallRoot=%%i" & goto :VsInstallRootDone
:VsInstallRootDone
